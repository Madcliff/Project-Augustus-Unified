...
NDiplomacy = {
	...
	PAGAN_PEACE_MONTHS = 48,					-- Months before the Peace Prestige loss kicks in for certain Pagan religions
...
NCharacter = {
	...
	CHANGE_SUCC_LAW_YEARS = 0,						-- Rulers must have reigned this long before they can change succession laws
	...
	RAISED_TROOPS_VASSAL_OPINION_DAYS = 80,			-- After 80 days of having their troops raised, vassals will get -1 opinion more of you
	...
	MAX_JOINED_FACTIONS = 10,						-- Maximum number of Factions a character can be a member of (including led factions)
...
-- Piety from giving titles to the Church or Holy Orders
	...
	KING_GRANT_TO_CHURCH_PIETY = 200,
	EMPEROR_GRANT_TO_CHURCH_PIETY = 300,
...
-- Title Grant Decadence Reduction (Multiplied with current decadence)
	...
	NORMAL_LAW_CHANGE_MONTHS = 12,
	MAX_CROWN_LAW_CHANGES = 99,
	TITLE_USURP_COOLDOWN_MONTHS = 0,
	...
	MAX_REPUBLIC_COUNTIES_IN_REALM = 1.0,		-- 10% of a feudal realm is allowed to be under vassal republics (affects title grants)
	MAX_THEOCRACY_COUNTIES_IN_REALM = 1.0,		-- 10% of a feudal realm is allowed to be under vassal theocracies/bishoprics (affects title grants)
	...
	MIN_REVOKE_MONTHS_AFTER_GRANT = 0,			-- Months that must pass before you can revoke the title off someone you granted it to
...
NEconomy = {
	...
	MIN_TRADE_POSTS = 12,							-- Minimum number of max trade posts per patrician	
	MIN_TRADETECH_LEVEL_FOR_TPS = 1,				-- Minimum tech level needed to build trade posts
	TRADETECH_LEVEL_FOR_BASE_TPS = 6,
...
NNomad = {
	POPULATION_INCREASE_MULTIPLIER = 0.015,			-- The rate current population grows or declines to max population
	MANPOWER_INCREASE_MULTIPLIER = 0.2,				-- The rate current manpower grows or declines to max manpower
	...
	MAX_POPULATION_EMPTY_HOLDING_MULTIPLIER = 3000, -- Max population increase for each empty holding in provinces where the capital is also an empty holding
	MAX_MANPOWER_POPULATION_MULTIPLIER = 0.40,		-- How big max manpower will be, determined by the current population value
	...
	START_POPULATION = 0.60,						-- Starting population, multiplied with max population
	START_MANPOWER = 0.55,							-- Starting manpower, multiplied with max manpower
	...
	PROVINCES_PER_CLAN = 3,							-- Used to calculate if you have too many clans
	MIN_CLAN_LAND_PROPORTION = 0.33,				-- Used to calculate when the clans get angry over you holding too much land
...
NMilitary = {
	...
	LEVY_MAINTENANCE_FACTOR = 1.0,					-- General maintenance factor for levy troops
	...
	OWN_SETTLEMENT_SUPPLY_BONUS = 1.0,				-- Extra supply from being in home realm
	...
	PAGAN_HOME_SUPPLY_MOD = 0.08,					-- Non Pagans suffer extreme attrition in some Pagan homelands (based on province religion)
	...
	RETINUE_INCREASE_PER_TECH = 0.10,
	RETINUE_HIRE_COST_MULTIPLIER = 0.10,			-- Retinues are free to hire atm, but they cost alot to reinforce
	RETINUE_REINFORCE_RATE = 0.1,
	RETINUE_REINFORCE_COST = 0.5,					-- Retinues cost while reinforcing.
	...
	MAX_COMMANDERS_BARON = 3,
	MAX_COMMANDERS_COUNT = 6,						-- How many commanders can a count have ( can also always assign self and marshal )
	MAX_COMMANDERS_DUKE = 9,
	MAX_COMMANDERS_KING = 12,
	MAX_COMMANDERS_EMPEROR = 15,
	...
	LIEGE_LEVY_SUBUNIT_SIZE_CUTOFF = 5000,			-- The max size of each liege levy subunit.
	...
	CAPITAL_COUNTY_VASSAL_LEVY_MULT = 1,		-- Used instead of CAPITAL_COUNTY_LEVY_MULT for non-count vassals
	CAPITAL_COUNTY_LEVY_MULT = 1,				-- Multiplier to direct levies in the capital county
	...
	OUTSIDE_LIEGE_LEVY_MULT = 1,				-- Multiplier to liege levies outside all capital regions
...
NAI =
{
	...
	RAID_MAX_REALM_SIZE = 99999,								-- Realms with more holdings than this will never go on Raids
